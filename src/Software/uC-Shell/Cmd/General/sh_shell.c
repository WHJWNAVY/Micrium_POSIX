...
static  CPU_INT16S  ShShell_help (CPU_INT16U        argc,
                                  ...
                                  SHELL_CMD_PARAM  *pcmd_param)
{
    CPU_CHAR           cmd_str[TERMINAL_CFG_MAX_CMD_LEN];
    SHELL_ERR          err;
    SHELL_CMD         *pcmd;
                                  ...
                                  SHELL_CMD_PARAM  *pcmd_param)
{
    ...
    if (argc == 2) {
        ...
        (void)out_fnct(SH_SHELL_NEW_LINE,   (CPU_INT16U)Str_Len(SH_SHELL_NEW_LINE),   pcmd_param->pout_opt);
        (void)out_fnct(SH_OUT_LINE_DELIMETER, (CPU_INT16U)Str_Len(SH_OUT_LINE_DELIMETER), pcmd_param->pout_opt);
        (void)out_fnct(SH_SHELL_NEW_LINE,   (CPU_INT16U)Str_Len(SH_SHELL_NEW_LINE),   pcmd_param->pout_opt);
